...
import com.kevin.storyappdicoding.utils.MainDispatcherRule
import com.kevin.storyappdicoding.utils.getOrAwaitValue
...
class HomeViewModelTest {
    ...
    fun `when Get Stories Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.storiesForList()).thenReturn(expectedStory.asFlow())

        val homeViewModel = HomeViewModel(storyRepository)
        homeViewModel.getStories()
        val actualStory: PagingData<Story> = homeViewModel.storiesResult.getOrAwaitValue()
